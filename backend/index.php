...
<body>
            ...
            <div class="col-6">
                <div class="gallery-container">
                    ...
                    <div class="gallery" id="gallery">
                        <img src="../logo.jpg" alt="Kép 1">
                        <img src="ujkepek/bmw.jpg" alt="Kép 2">
                        <img src="ujkepek/ford_focus.jpg" alt="Kép 3">
                        <img src="ujkepek/skoda.jpg" alt="Kép 4">
                        <img src="ujkepek/mercedes_cla.jpg" alt="Kép 6">
                        <img src="ujkepek/honda_civic.jpg" alt="Kép 7">
                        <img src="ujkepek/aston_martind9_coupe.jpg" alt="Kép 8">
                        <img src="ujkepek/ferrrari.jpg" alt="Kép 9">
                        <img src="ujkepek/ford_lakoauto.jpg" alt="Kép 10">
                    </div>
            ...
            <div class="col-6">
                <div>
                    <p id="pp"> Az utazás nem csupán az úti célról szól, hanem magáról az élményről is. A DriveUs-nál arra
                        ...
                        velünk!</p>
                    <button id="foglalj" class="book-now" onclick="window.location.href='../autok/autok.php'">
                        FOGLALJ MOST!
                    </button>
                </div>
            </div>
    ...
    <script src="../fooldal/script.js"></script>
</body>
</html>